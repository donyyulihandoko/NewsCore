<x-admin-layout>
    ...
    <x-slot name="header">
        <div class="flex items-center space-x-3">
            ...
            <div>
                <h2 class="text-2xl font-bold text-gray-900 dark:text-white">Update Category</h2>
                <p class="text-sm text-gray-500 dark:text-gray-400">Update category to organize your blog posts.</p>
            </div>
        </div>
    </x-slot>
                ...
                <div class="grid gap-6 mb-6">
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="4"
                            ...
                            placeholder="Brief explanation about this category...">{{ old('description', $category->description) }}</textarea>
                    </div>
                </div>

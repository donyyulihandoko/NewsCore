    ...
    <x-slot name="header">
        <div class="flex items-center space-x-3">
            ...
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400">Update your category details.</p>
            </div>
        </div>
    </x-slot>

    <div class="max-w-6xl mx-auto py-8">
        {{-- Gunakan enctype multipart karena ada update gambar --}}
        <form action="{{ route('admin.categories.update', $category) }}" method="POST"
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="5"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-3 dark:bg-gray-700 dark:border-gray-600 dark:text-white">{{ old('description', $category->description) }}</textarea>
                ...
                <div class="space-y-6">
                    <div x-data="{ imagePreview: '{{ Str::startsWith($category->image, 'http') ? $category->image : Storage::url($category->image) }}' }"
                        class="p-6 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-sm">
                        ...
                        <div @click="$refs.fileInput.click()" class="cursor-pointer">
                            <div x-show="!imagePreview"
                                ...
                                <span class="text-xs text-gray-500 mt-2">Click to replace</span>
                            </div>

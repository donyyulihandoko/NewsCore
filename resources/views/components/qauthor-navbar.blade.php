            ...
            <div class="flex items-center space-x-10">
                ...
                <div class="hidden md:flex space-x-8 text-sm font-semibold uppercase tracking-wider">
                    ...
                    <a href="{{ route('author.posts.index') }}"
                        class="hover:text-blue-600 transition-colors {{ request()->routeIs('author.posts.index') ? 'text-blue-600' : 'text-gray-500' }}">My Post</a>
                    <a href="{{ route('author.posts.create') }}"
                        class="hover:text-blue-600 transition-colors {{ request()->routeIs('author.posts.create') ? 'text-blue-600' : 'text-gray-500' }}">Write New</a>
                </div>
            </div>
